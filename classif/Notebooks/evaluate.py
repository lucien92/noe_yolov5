...
train_ds = keras.utils.image_dataset_from_directory(
    directory='/home/acarlier/code/projet_abeilles/abeilles-cap500/cap500/train_cap_andrena',
    labels='inferred',
...
test_ds = keras.utils.image_dataset_from_directory(
    directory='/home/acarlier/code/projet_abeilles/abeilles-cap500/cap500/test_cap_andrena',
    labels='inferred',
    label_mode='categorical',
    batch_size=16,
    image_size=(IMG_SIZE, IMG_SIZE))
...
x_test = np.zeros((552, IMG_SIZE, IMG_SIZE, 3))
...
print("LOOK HERE", true_labels)
predicted_labels = np.argmax(y_pred, axis=1)
print(len(y_test))
print(y_test[:50])
print(y_test[150:200])
print(y_test[50:])
...
class_name = "Anthidium manicatum"
mauvais_label = "Anthidium florentinum"
...
# class_name = "andrena lucorum"
# mauvais_label = "andrena vestalis"
# dic = get_misclassified_images(class_name, file_paths, true_y, predicted_y)
# #pprint.pprint(dic, width=1)
