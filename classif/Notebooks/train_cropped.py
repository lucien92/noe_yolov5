...
train_ds = tf.keras.utils.image_dataset_from_directory(
    directory='/media/lucien/My Passport/projet_abeilles/abeilles-cap500/cells_split/train',
    labels='inferred',
...
validation_ds = keras.utils.image_dataset_from_directory(
    directory='/media/lucien/My Passport/projet_abeilles/abeilles-cap500/cells_split/val',
    labels='inferred',
    label_mode='categorical',
    batch_size=16,
    image_size=(IMG_SIZE, IMG_SIZE))
...
y_train = np.zeros((3804, nb_classes))#rentrer la taille du train
...
x_val = np.zeros((468, IMG_SIZE, IMG_SIZE, 3))#rentrer la taille du valval
y_val = np.zeros((468, nb_classes))#rentrer la taille du val
...
hierarchie = pd.read_csv("/media/lucien/My Passport/projet_abeilles/abeilles-cap500/csv/hierarchie_espèces_bombus.csv")
...
data = pd.read_csv("/media/lucien/My Passport/projet_abeilles/abeilles-cap500/csv/liste_classes_71.csv")
...
model_checkpoint_cb = tf.keras.callbacks.ModelCheckpoint(
    filepath='/home/acarlier/Desktop/model_crop_bombus/model', 
