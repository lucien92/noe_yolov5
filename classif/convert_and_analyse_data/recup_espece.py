...
path_csv = "/home/lucien/projet_lepinoc/lepinoc-detection/classif/convert_and_analyse_data/correct_list.csv"
...
error = []
with open('/home/lucien/projet_lepinoc/lepinoc-detection/classif/convert_and_analyse_data/especes.csv', 'w') as f:
    f.write('Especes,0\n')
    for item in L:
