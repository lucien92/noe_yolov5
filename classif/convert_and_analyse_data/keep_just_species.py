...
path_to_data = "dbfs:/FileStore/tables/data_lepinoc/cleaned_data_above30"
try:
    os.mkdir("dbfs:/FileStore/tables/data_lepinoc/final_cleaned_data")
except:
    pass
...
for espece in os.listdir(path_to_data):
    if espece in espece:
        os.system('cp -r "' + path_to_data + '/' + espece + '" "dbfs:/FileStore/tables/data_lepinoc/final_cleaned_data"')
